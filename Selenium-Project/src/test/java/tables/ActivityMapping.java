...
public class ActivityMapping {
    ...
    /*
     On Insurance app "https://dev.insurance.tekschool-students.com/", login with supervisor / tek_supervisor
     credentials, and go to plans section and Map Plan Type with Plan Base price. Use SeleniumUtility
    Auto=$140.00
    Renter=$xxx
     */
